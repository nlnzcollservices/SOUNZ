...
def parse_pdf ( file_path):
	...
	try:
		return ({"title":cleaned(title), "subtitle":cleaned(subtitle), "year":copyright_year,"author":copyright_holder,"message":message})
	except:
		None
