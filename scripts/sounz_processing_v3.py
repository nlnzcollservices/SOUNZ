    ...
    for fl in files:
        ...
        if ".pdf" in fl:# and fl == "29307_dl copy.pdf":
            ...
            if my_dict:
                ...
                print( "7. Writing ")
                with open(os.path.join(working_folder,"log","reports","sounz_{}.txt".format(Times.underscore())),"a") as f:
                    f.write(fl+"|"+mms+"|"+pol_no+"|"+pid+"|"+my_dict["message"]+"\n")
                ...
                print(working_folder)
                print( "7. Writing ")
                with open(os.path.join(working_folder,"log","reports","sounz_phys_{}.txt".format(Times.underscore())),"a") as f:
                    f.write(fl+"|"+mms+"|"+pol_no+"|"+pid+"|"+my_dict["message"]+"\n")
            # else:
